...
class WordEmbeddings:
    ...
    def get_initialized_embedding_layer(self, frozen=True):
        ...
        """
        # print(f'Vector dtype: {self.vectors.dtype}')
        # print(f'Embedding shape: {self.vectors.shape}')
    ...
    def get_embedding(self, word):
        ...
        #print(f"get_embedding for word '{word}': index = {word_idx}, type = {type(word_idx)}")
        if word_idx != -1:
            return word_idx 
